...
--[[
	Las lenguetas tienen que entrar las OCHO en el alto de la pagina.
	Con las medidas del primer pase (46 de alto y 8 de separacion) la
	pila medira 424 y la libreta 436: las dos ultimas se salian por
	abajo del papel.
--]]
local TAB_W, TAB_H, TAB_GAP = 46, 40, 6
