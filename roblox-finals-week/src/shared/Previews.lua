...
local BUILDERS: { [string]: (Model) -> () } = {
	...
	celular = function(model)
		part(model, Vector3.new(0.75, 1.5, 0.12), CFrame.new(0, 0, 0),
			Color3.fromRGB(22, 24, 30))
		part(model, Vector3.new(0.64, 1.28, 0.04), CFrame.new(0, 0.04, -0.07),
			Color3.fromRGB(96, 168, 240), Enum.Material.Neon)
	end,
