...
--[[
	Instalador
	------------------------------------------------------------------
	Esto es lo unico que tenes que insertar. Adentro viene el juego
	entero, y al arrancar se acomoda solo:

		Shared -> ReplicatedStorage
		Client -> StarterPlayer/StarterPlayerScripts
		Server -> ServerScriptService

	Roblox obliga a que el codigo del servidor y el del cliente vivan en
	servicios distintos (si no, cualquiera podria leer las respuestas de
	la prueba), pero eso no es problema tuyo: lo hace este script.

	El "Server" viene apagado a proposito y se prende recien cuando
	"Shared" ya esta en su lugar, porque lo primero que hace es buscarlo.
--]]
...
if server and server:IsA("Script") then
	...
	print("[Instalador] Listo: el juego quedo instalado en este lugar.")
else
