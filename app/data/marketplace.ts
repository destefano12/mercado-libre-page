...
export const listings: Listing[] = [
  {
    id: "erlc-tools-kit",
    title: "Kit de herramientas Liberty County",
    description: "Set de rol con linterna, conos, radio, bolso de rescate y herramientas para trabajos dentro de Liberty County.",
    ...
    sold: 0,
    rating: 0,
    tags: ["erlc", "liberty county", "herramientas", "radio", "linterna", "roleplay"],
    meta: { marca: "Liberty County", rubro: "Herramientas", alimentacion: "Manual", garantia: "7 dias" },
    badge: "ER:LC",
    source: "catalog",
    visual: {
      type: "image",
      src: assetSource(erlcToolsKit),
      alt: "Kit de herramientas Liberty County",
  ...
  {
    id: "erlc-blue-car",
    title: "Auto civil azul Liberty County",
    description: "Vehiculo civil estilo Liberty County para recorrer River City, zonas residenciales y rutas del mapa.",
    ...
    sold: 0,
    rating: 0,
    tags: ["erlc", "liberty county", "auto", "vehiculo", "civil", "roblox"],
    meta: { marca: "Liberty County Motors", año: "2026", kilometraje: "0 km", transmision: "Automatica" },
    badge: "Vehiculo",
    source: "catalog",
    visual: {
      type: "image",
      src: assetSource(erlcBlueCar),
      alt: "Auto civil azul Liberty County",
      objectPosition: "center",
    },
    images: [assetSource(erlcBlueCar)],
  },
  {
    id: "erlc-burger-meal",
  ...
  {
    id: "erlc-drone-kit",
    title: "Drone de vigilancia Liberty County",
    description: "Drone con control remoto inspirado en los gadgets de Liberty County para recorridos, vigilancia y rol civil.",
    ...
    sold: 0,
    rating: 0,
    tags: ["erlc", "liberty county", "drone", "gadget", "tecnologia", "camara"],
...
import erlcBlueCar from "@/IMG/erlc/erlc-blue-car.png";
