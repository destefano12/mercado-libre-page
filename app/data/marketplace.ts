...
export const users: UserProfile[] = [
  ...
  {
    id: "u-erlc-catalog",
    name: "Liberty County Store",
    email: "liberty@demo.local",
    location: "Liberty County 308",
    avatar: "LC",
    reputation: 0,
...
export const listings: Listing[] = [
  {
    id: "erlc-tools-kit",
    title: "Pack Tool Store: Lockpick, RFID y Scanner",
    description: "Pack con herramientas reales del Tool Store de ER:LC: Lockpick, RFID Disruptor, Scanner, Flashlight, Drill y Spray Can.",
    categoryId: "herramientas",
    sellerId: "u-erlc-catalog",
    price: 3830,
    oldPrice: 4260,
    currency: "ARS",
    condition: "Nuevo",
    location: "Liberty County 308",
    shipping: "Llega hoy por repartidor",
    createdAt: "2026-07-26T10:05:00.000Z",
    views: 0,
    sold: 0,
    rating: 0,
    tags: ["erlc", "liberty county", "tool store", "lockpick", "rfid disruptor", "scanner", "flashlight", "drill", "spray can"],
    meta: { marca: "Tool Store", rubro: "Herramientas", alimentacion: "Manual", garantia: "Sin garantia" },
    badge: "Tool Store",
    source: "catalog",
    visual: {
      type: "image",
      src: assetSource(erlcToolsKit),
      alt: "Pack Tool Store con Lockpick RFID Scanner Flashlight Drill y Spray Can",
      objectPosition: "center",
    },
    images: [assetSource(erlcToolsKit)],
  },
  {
    id: "erlc-strugatti-ettore-2020",
    title: "Strugatti Ettore 2020",
    description: "Vehiculo prestige de ER:LC. En la wiki figura como Strugatti Ettore 2020, basado en un hypercar tipo Bugatti Chiron.",
    ...
    condition: "Nuevo",
    location: "Liberty County 308",
    shipping: "Coordinar retiro o envio",
    createdAt: "2026-07-26T10:04:00.000Z",
    views: 0,
    sold: 0,
    rating: 0,
    tags: ["erlc", "liberty county", "strugatti ettore 2020", "strugatti", "vehiculo", "prestige", "hypercar"],
    meta: { marca: "Strugatti", año: "2020", kilometraje: "0 mi", transmision: "Automatica" },
    badge: "Prestige",
    source: "catalog",
    visual: {
      type: "image",
      src: assetSource(erlcStrugattiEttore2020),
      alt: "Strugatti Ettore 2020",
      objectPosition: "center",
    },
    images: [assetSource(erlcStrugattiEttore2020)],
  },
  {
    id: "erlc-falcon-traveller-2003",
    title: "Falcon Traveller 2003",
    description: "Vehiculo civil real de la lista de ER:LC. Modelo Falcon Traveller 2003 para rol urbano y recorridos por Liberty County.",
    categoryId: "vehiculos",
    sellerId: "u-erlc-catalog",
    price: 12500,
    currency: "ARS",
    ...
    location: "Liberty County 308",
    shipping: "Coordinar retiro o envio",
    createdAt: "2026-07-26T10:03:30.000Z",
    views: 0,
    sold: 0,
    rating: 0,
    tags: ["erlc", "liberty county", "falcon traveller 2003", "falcon", "vehiculo", "civil"],
    meta: { marca: "Falcon", año: "2003", kilometraje: "0 mi", transmision: "Automatica" },
    badge: "Civil",
    source: "catalog",
    visual: {
      type: "image",
      src: assetSource(erlcFalconTraveller2003),
      alt: "Falcon Traveller 2003",
      objectPosition: "center",
    },
    images: [assetSource(erlcFalconTraveller2003)],
  },
  {
    id: "erlc-burger-meal",
    title: "Combo hamburguesa Three Guys",
    description: "Combo de hamburguesa, papas y bebida inspirado en el restaurante Three Guys Burgers and Fries de Liberty County.",
    ...
    condition: "Nuevo",
    location: "Liberty County 308",
    shipping: "Entrega rapida en zonas residenciales",
    createdAt: "2026-07-26T10:03:00.000Z",
    views: 0,
    sold: 0,
    rating: 0,
    tags: ["erlc", "liberty county", "hamburguesa", "three guys", "comida", "supermercado"],
    meta: { marca: "Three Guys", tipo: "Comida rapida", formato: "Combo", entrega: "En el dia" },
    badge: "Combo",
    source: "catalog",
    visual: {
      type: "image",
      src: assetSource(erlcBurgerMeal),
      alt: "Combo hamburguesa Three Guys",
      objectPosition: "center",
    },
    images: [assetSource(erlcBurgerMeal)],
  },
  {
    id: "erlc-drone-kit",
    title: "Drone GadgetShack",
    description: "Drone real de ER:LC comprado en GadgetShack/Tool Store para surveying y vigilancia de un area amplia.",
    ...
    sold: 0,
    rating: 0,
    tags: ["erlc", "liberty county", "drone", "gadgetshack", "tool store", "surveying"],
    meta: { marca: "GadgetShack", modelo: "Drone", conectividad: "Control remoto", estado: "Nuevo" },
    badge: "Tool Store",
    source: "catalog",
    visual: {
      type: "image",
      src: assetSource(erlcDroneKit),
      alt: "Drone de vigilancia Liberty County",
      objectPosition: "center",
    },
    images: [assetSource(erlcDroneKit)],
  },
  {
    id: "erlc-phone",
    title: "Celular Liberty County con cargador",
    description: "Telefono civil para rol, llamadas y coordinacion de pedidos dentro del mapa Liberty County.",
    categoryId: "tecnologia",
    sellerId: "u-erlc-catalog",
    price: 96000,
    currency: "ARS",
    ...
    sold: 0,
    rating: 0,
    tags: ["erlc", "liberty county", "celular", "telefono", "smartphone", "tecnologia"],
    meta: { marca: "Liberty Mobile", modelo: "RP Phone", almacenamiento: "128 GB", estado: "Nuevo" },
    badge: "Nuevo",
    source: "catalog",
    visual: {
      type: "image",
      src: assetSource(erlcPhone),
      alt: "Celular Liberty County con cargador",
      objectPosition: "center",
    },
    images: [assetSource(erlcPhone)],
  },
  {
    id: "stream-hbo",
...
import erlcToolsKit from "@/IMG/erlc/erlc-tools-kit.png";
import erlcBurgerMeal from "@/IMG/erlc/erlc-burger-meal.png";
import erlcDroneKit from "@/IMG/erlc/erlc-drone-kit.png";
import erlcPhone from "@/IMG/erlc/erlc-phone.png";
import erlcStrugattiEttore2020 from "@/IMG/erlc/erlc-strugatti-ettore-2020.png";
import erlcFalconTraveller2003 from "@/IMG/erlc/erlc-falcon-traveller-2003.png";
